<x-main-layout pageTitle="Game">
    ...
    <div class="container">
        ...
        <div class="row fs-3">
            ...
            <div class="col text-info">{{ session()->get('total_questions') }}</div>
        </div>
        <div class="row fs-3">
            <div class="col text-end">Respostas Certas:</div>
            <div class="col text-success">{{ session()->get('correct_answers') }}</div>
        </div>
        <div class="row fs-3">
            <div class="col text-end">Respostas Erradas:</div>
            <div class="col text-danger">{{ session()->get('wrong_answers') }}</div>
        </div>
        <div class="row fs-1">
